...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("hexarchy-launch-floating-terminal-with-presentation")
        binary = shutil.which("hexarchy-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="HexarchyTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("hexarchy-launch-floating-terminal-with-presentation")
            and shutil.which("hexarchy-transcode")
        )
