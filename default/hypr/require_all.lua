...
-- Used for Hexarchy extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/hexarchy/toggles/hypr.
-- Pass a module prefix for normal package.path modules, e.g.
--   require_all.files(paths.hexarchy_path .. "/default/hypr/apps", "default.hypr.apps")
