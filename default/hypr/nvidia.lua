...
local nvidia = paths.hexarchy_path .. "/bin/hexarchy-hw-nvidia"
local nvidia_gsp = paths.hexarchy_path .. "/bin/hexarchy-hw-nvidia-gsp"
local nvidia_without_gsp = paths.hexarchy_path .. "/bin/hexarchy-hw-nvidia-without-gsp"
