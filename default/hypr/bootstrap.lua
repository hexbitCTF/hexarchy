-- Hyprland bootstrap for Hexarchy's Lua module path.

local home = os.getenv("HOME")
local reload_prefixes = {
  "default.hypr",
  "hypr",
  "hexarchy.current.theme",
}
...
-- Hexarchy defaults from $HEXARCHY_PATH.
package.path = home
  .. "/.local/state/?.lua;"
  .. home
  .. "/.config/?.lua;"
  .. (os.getenv("HEXARCHY_PATH") or "/usr/share/hexarchy")
  .. "/?.lua;"
  .. package.path
