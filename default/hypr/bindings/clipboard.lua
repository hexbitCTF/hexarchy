...
-- layer-shell surfaces such as Hexarchy panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "hexarchy-shell shell toggle hexarchy.clipboard")
