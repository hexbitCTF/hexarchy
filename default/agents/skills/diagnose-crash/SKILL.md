...
description: >
  ...
  Covers reporting a confirmed Hexarchy bug upstream — see reporting.md.
---
...
## If it is an Hexarchy bug

Most application crashes are upstream bugs in those applications, not Hexarchy's
doing. In the minority of cases where the cause really does sit within Hexarchy's
