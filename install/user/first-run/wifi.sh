notify_update() {
  hexarchy-notification-send -u critical -g  "Update System" "Click to update the system." \
    --exec hexarchy-launch-floating-terminal-with-presentation hexarchy-update
}

notify_wifi() {
  hexarchy-notification-send -u critical -g 󰖩 "Setup Wi-Fi" "Click to configure the wireless network." \
    --exec hexarchy-shell shell toggle hexarchy.network
}
