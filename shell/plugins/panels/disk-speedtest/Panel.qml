...
// hexarchy-disk-speedtest run streams both phases and cleans up after itself,
...
Item {
  ...
  function dismiss() {
    if (shell && typeof shell.hide === "function")
      shell.hide((manifest && manifest.id) || "hexarchy.disk-speedtest")
    else close()
  }
  ...
  Process {
    id: proc
    command: ["hexarchy-disk-speedtest"]
  ...
  SpeedTestOverlay {
    ...
    layerNamespace: "hexarchy-disk-speedtest"
    title: root.diskName
    leftLabel: "READ"
    rightLabel: "WRITE"
    unit: "MB/s"
