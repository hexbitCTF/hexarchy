...
// Visual reference + live playground for hexarchy-shell's common UI
// components. Summon with `hexarchy dev ui-preview`, or directly via:
//   hexarchy-shell shell summon hexarchy.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `hexarchy dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("hexarchy.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "Hexarchy shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("hexarchy.dev-gallery")
    }
      ...
      PanelKeyCatcher {
        ...
        Column {
          ...
          Column {
            ...
            Text {
              text: "Hexarchy shell · dev gallery"
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `hexarchy font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["hexarchy.clock", "hexarchy.weather", "hexarchy.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "hexarchy.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "hexarchy-menu", label: "Hexarchy menu", description: "Launcher / system menu" },
