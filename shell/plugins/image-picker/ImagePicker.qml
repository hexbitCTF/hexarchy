...
Item {
  ...
  // Injected by hexarchy-shell; defaults to the session HEXARCHY_PATH.
  property string hexarchyPath: Quickshell.env("HEXARCHY_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("HEXARCHY_IMAGE_SELECTOR_DIRS") || Quickshell.env("HEXARCHY_IMAGE_SELECTOR_DIR") || Quickshell.env("HEXARCHY_STOCK_BACKGROUNDS_DIR") || (stateHome + "/hexarchy/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("HEXARCHY_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("HEXARCHY_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("HEXARCHY_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return hexarchyPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by hexarchy-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "hexarchy-image-selector"
