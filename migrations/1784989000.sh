  ...
  jq '
    ...
    def place_indicators_before_clock:
      if type != "array" then
        ...
        (entry_index("hexarchy.clock")) as $clock_index |
        (entry_index("hexarchy.indicators")) as $indicators_index |
        if $clock_index == null or $indicators_index == null or $indicators_index < $clock_index then
          ...
          ($without_indicators | entry_index("hexarchy.clock")) as $new_clock_index |
