...
legacy_absolute_target="$HOME/.config/hexarchy/current/theme/neovim.lua"
legacy_relative_target="../../../hexarchy/current/theme/neovim.lua"
legacy_home_target="~/.config/hexarchy/current/theme/neovim.lua"
