...
# hexarchy-migrate records this migration complete on any zero exit, so the
...
# hexarchy-migrate writes this migration's completion marker on any zero exit, so
