...
class StatusNotifierItem(dbus.service.Object):
  ...
  def GetAll(self, interface):
    ...
    return dbus.Dictionary({
      ...
      "Id": "hexarchy-test-tray",
      "Title": "hexarchy-test-tray",
      "Status": "Active",
...
def run():
  event_path = os.environ["HEXARCHY_TRAY_MENU_EVENT_RESULT"]
  ready_path = os.environ["HEXARCHY_TRAY_MENU_READY"]

  DBusGMainLoop(set_as_default=True)
  bus = dbus.SessionBus()
  dbus.service.BusName("org.hexarchy.TestStatusNotifier", bus)
