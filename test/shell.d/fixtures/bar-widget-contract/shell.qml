...
ShellRoot {
  ...
  function widgets() {
    try {
      return JSON.parse(Qt.atob(Quickshell.env("HEXARCHY_QML_BAR_WIDGETS") || "W10="))
    } catch (error) {
