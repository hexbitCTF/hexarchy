...
flag="$test_home/.local/state/hexarchy/toggles/example"
bar_flag="$test_home/.local/state/hexarchy/toggles/bar-off"

HOME="$test_home" hexarchy-toggle example on
...
HOME="$test_home" hexarchy-toggle-bar off
